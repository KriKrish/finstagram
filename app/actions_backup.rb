def humanized_time_ago(minutes_num)
    if minutes_num >=60
        "#{minutes_num / 60} hours ago"
    else
        "#{minutes_num} minutes ago"
    end
end
...
@finstagram_posts = [@finstagram_post_Angel, @finstagram_post_blue_Honey, @finstagram_post_Red_Honey]
erb(:index)
end
